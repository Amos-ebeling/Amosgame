...
void Audio::load_sounds(const std::unordered_map<std::string, std::string> sound_files) {
    auto path =std::filesystem::current_path() / "assets" / "Basic_Music.mp3";
...
void Audio::play_sounds(const std::string& sound_name, bool loop_forever_in_backround) {
